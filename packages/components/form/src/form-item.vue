...
import type { FormItemValidateState } from './type/form-item'
...
import { useNamespace, useSize, useId, refDebounced } from '@wind-ui/hooks'
...
const doValidate = async (_rules: RuleItem[]): Promise<true> => {
